...
import com.devcore.pos_system.dto.Cart;
import com.devcore.pos_system.entity.Category;
import com.devcore.pos_system.entity.GoodsReceipt;
import com.devcore.pos_system.entity.GoodsReceiptItem;
import com.devcore.pos_system.entity.PaymentMethod;
import com.devcore.pos_system.entity.Product;
import com.devcore.pos_system.entity.PurchaseOrder;
import com.devcore.pos_system.entity.PurchaseOrderItem;
import com.devcore.pos_system.entity.PurchaseOrderStatus;
import com.devcore.pos_system.entity.Sale;
import com.devcore.pos_system.entity.SalePayment;
import com.devcore.pos_system.entity.Shift;
import com.devcore.pos_system.entity.ShiftStatus;
import com.devcore.pos_system.entity.Supplier;
import com.devcore.pos_system.entity.SupplierStatus;
import com.devcore.pos_system.repository.CategoryRepo;
import com.devcore.pos_system.repository.GoodsReceiptRepo;
import com.devcore.pos_system.repository.ProductRepo;
import com.devcore.pos_system.repository.PurchaseOrderRepo;
import com.devcore.pos_system.repository.SaleRepo;
import com.devcore.pos_system.repository.SupplierRepo;
import com.devcore.pos_system.service.InventoryService;
import com.devcore.pos_system.service.PosService;
import com.devcore.pos_system.service.ShiftService;
import com.devcore.pos_system.service.StockMovementService;
...
public class DevDataSeeder implements CommandLineRunner {
    ...
    private void seedSampleSales() {
        ...
        if (products.size() > 2) {
            ...
            secondCart.setDiscountType(com.devcore.pos_system.entity.DiscountType.PERCENT);
